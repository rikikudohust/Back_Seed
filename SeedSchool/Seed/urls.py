...
from .views import LoginView,LogoutView, TeacherSchdeduleDailyView, TeacherScheduleView, TeacherStudentView, TeacherView,UserView,StudentView,StudentScheduleView, TeacherClassView, StudentAttendanceView
